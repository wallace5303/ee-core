...
import depd from "../../../utils/depd/index.js";
import Utils from "../utils/index.js";
'use strict';
const debug = debug$0('ee-core:fileLoader');
const deprecate = depd('ee');
    ...
    loadAddons() {
        ...
        for (const directory of directories) {
            ...
            for (const addonName of addonpaths) {
                if (filterAddons.includes(addonName))
                    continue;
