...
'use strict';
const debug = debug$0('ee-core:config');
...
export const loadConfig = moduleExports.loadConfig;
export const _preloadAppConfig = moduleExports._preloadAppConfig;
export const _loadConfig = moduleExports._loadConfig;
export const _loadConfigFromEnv = moduleExports._loadConfigFromEnv;
export const _setConfigMeta = moduleExports._setConfigMeta;
const moduleExports = {
    /**
