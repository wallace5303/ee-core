...
class BaseApp extends EeAppCore {
  ...
  initSocket () {
    ...
    // this.console.info('[baseApp] [getStorage] filepath:', filepath);
    // this.loader.loadFile(filepath);
    return require('./socket').getInstance();
  }
   ...
   */
  getSocket () {
    // let filepath = this.loader.resolveModule(path.join(this.eeCoreDir, 'lib', 'socket.js'));
    // this.console.info('[baseApp] [getSocket] filepath:', filepath);
    // let s = this.loader.loadFile(filepath);
