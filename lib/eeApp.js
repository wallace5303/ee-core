...
class EeApp extends BaseApp {
  ...
  catchLog () {
    ...
    process.on("SIGUSR2", function () {
      ...
      self.logger.error('aaaaaaaaaa');
    });
    process.on("SIGHUP", function () {
      console.log('bbbbbbbbbbbbbbb');
      self.logger.error('bbbbbbbbbbbbbbb');
    });
    process.on("SIGTERM", function () {
      console.log('cccccccccccc');
      self.logger.error('cccccccccccc');
    });
    process.on("SIGBREAK", function () {
      console.log('ddddddddddd');
      self.logger.error('ddddddddddd');
    });
    process.on("SIGKILL", function () {
      console.log('eeeeeeeeeeeee');
      self.logger.error('eeeeeeeeeeeee');
    });
    process.on("SIGINT", function () {
      console.log('ffffffffffffff');
      
    });
    self.logger.error('fffffffffffffff');

    // process.on('uncaughtException', function(err) {
    //   self.logger.error(err);
    //   self.logger.error('ttttttttttttttttttt');
    //   console.log('aaaaaaaaaaaaa');
    // });
    
    // if (process.platform === "win32") {
    //   self.logger.error('aaaaaaaaaaaaa');
    ...
    //     self.logger.error('bbbbbbbbbbbbb');
    //     self.logger.error('process.stdin:', process.stdin);
    //     self.logger.error('process.stdout:', process.stdout);
    //   });
    // }
  ...
  // })
    ...
    //   self.logger.error('SIGQUIT Exit now!');
    //   self.appQuit();
    // });
    // process.once('SIGTERM', function () {
    //   self.logger.error('SIGTERM Exit now!');
    // });
    // process.once('exit', function () {
    //   self.logger.error('exit Exit now!');
    // });
  }
