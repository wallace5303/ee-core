...
export const dev = moduleExports.dev;
export const start = moduleExports.start;
export function sleep(ms) {
    return new Promise(resolve => setTimeout(resolve, ms));
}
export const build = moduleExports.build;
export const exec = moduleExports.exec;
export const multiExec = moduleExports.multiExec;
const moduleExports = {
    execProcess,
    /**
     * 启动前端、主进程服务
