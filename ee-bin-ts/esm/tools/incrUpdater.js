...
export const generateFile = moduleExports.generateFile;
export const generateFileOld = moduleExports.generateFileOld;
export function generateSha1(filepath = "") {
    let sha1 = '';
...
export function _getFormattedDate() {
